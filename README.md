...
Dockerized [Claude Code](https://docs.anthropic.com/en/docs/claude-code) environment that reads EMC (Electromagnetic Compatibility) lecture slides and automatically generates study materials -- knowledge files, concise notes, exam examples, practice questions, and rendered PDFs with LaTeX equations.
...
└── WorkingDir/                         # Mounted as /workspace inside the container
    ...
    │   └── .gitkeep
    ├── templates/
    │   └── notes-template.tex          # LaTeX template for PDF output
...
git clone https://github.com/WolfN3r/SEM_S26-EMC-FirstMidterm_notes.git
cd SEM_S26-EMC-FirstMidterm_notes
cp .env.example .env
